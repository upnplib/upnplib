...
#define sk_X509_LOOKUP_num(sk)                                                 \
    OPENSSL_sk_num(ossl_check_const_X509_LOOKUP_sk_type(sk))
#define sk_X509_LOOKUP_value(sk, idx)                                          \
    ((X509_LOOKUP*)OPENSSL_sk_value(ossl_check_const_X509_LOOKUP_sk_type(sk),  \
                                    (idx)))
#define sk_X509_LOOKUP_new(cmp)                                                \
    ((STACK_OF(X509_LOOKUP)*)OPENSSL_sk_new(                                   \
        ossl_check_X509_LOOKUP_compfunc_type(cmp)))
#define sk_X509_LOOKUP_new_null()                                              \
    ((STACK_OF(X509_LOOKUP)*)OPENSSL_sk_new_null())
#define sk_X509_LOOKUP_new_reserve(cmp, n)                                     \
    ((STACK_OF(X509_LOOKUP)*)OPENSSL_sk_new_reserve(                           \
        ossl_check_X509_LOOKUP_compfunc_type(cmp), (n)))
#define sk_X509_LOOKUP_reserve(sk, n)                                          \
    OPENSSL_sk_reserve(ossl_check_X509_LOOKUP_sk_type(sk), (n))
#define sk_X509_LOOKUP_free(sk)                                                \
    OPENSSL_sk_free(ossl_check_X509_LOOKUP_sk_type(sk))
#define sk_X509_LOOKUP_zero(sk)                                                \
    OPENSSL_sk_zero(ossl_check_X509_LOOKUP_sk_type(sk))
...
#define sk_X509_LOOKUP_delete_ptr(sk, ptr)                                     \
    ((X509_LOOKUP*)OPENSSL_sk_delete_ptr(ossl_check_X509_LOOKUP_sk_type(sk),   \
                                         ossl_check_X509_LOOKUP_type(ptr)))
#define sk_X509_LOOKUP_push(sk, ptr)                                           \
    OPENSSL_sk_push(ossl_check_X509_LOOKUP_sk_type(sk),                        \
                    ossl_check_X509_LOOKUP_type(ptr))
#define sk_X509_LOOKUP_unshift(sk, ptr)                                        \
    OPENSSL_sk_unshift(ossl_check_X509_LOOKUP_sk_type(sk),                     \
                       ossl_check_X509_LOOKUP_type(ptr))
#define sk_X509_LOOKUP_pop(sk)                                                 \
    ((X509_LOOKUP*)OPENSSL_sk_pop(ossl_check_X509_LOOKUP_sk_type(sk)))
...
#define sk_X509_LOOKUP_pop_free(sk, freefunc)                                  \
    OPENSSL_sk_pop_free(ossl_check_X509_LOOKUP_sk_type(sk),                    \
                        ossl_check_X509_LOOKUP_freefunc_type(freefunc))
#define sk_X509_LOOKUP_insert(sk, ptr, idx)                                    \
    OPENSSL_sk_insert(ossl_check_X509_LOOKUP_sk_type(sk),                      \
                      ossl_check_X509_LOOKUP_type(ptr), (idx))
#define sk_X509_LOOKUP_set(sk, idx, ptr)                                       \
    ((X509_LOOKUP*)OPENSSL_sk_set(ossl_check_X509_LOOKUP_sk_type(sk), (idx),   \
                                  ossl_check_X509_LOOKUP_type(ptr)))
#define sk_X509_LOOKUP_find(sk, ptr)                                           \
    OPENSSL_sk_find(ossl_check_X509_LOOKUP_sk_type(sk),                        \
                    ossl_check_X509_LOOKUP_type(ptr))
#define sk_X509_LOOKUP_find_ex(sk, ptr)                                        \
    OPENSSL_sk_find_ex(ossl_check_X509_LOOKUP_sk_type(sk),                     \
                       ossl_check_X509_LOOKUP_type(ptr))
#define sk_X509_LOOKUP_find_all(sk, ptr, pnum)                                 \
    OPENSSL_sk_find_all(ossl_check_X509_LOOKUP_sk_type(sk),                    \
                        ossl_check_X509_LOOKUP_type(ptr), pnum)
#define sk_X509_LOOKUP_sort(sk)                                                \
    OPENSSL_sk_sort(ossl_check_X509_LOOKUP_sk_type(sk))
#define sk_X509_LOOKUP_is_sorted(sk)                                           \
    OPENSSL_sk_is_sorted(ossl_check_const_X509_LOOKUP_sk_type(sk))
#define sk_X509_LOOKUP_dup(sk)                                                 \
    ((STACK_OF(X509_LOOKUP)*)OPENSSL_sk_dup(                                   \
...
#define sk_X509_LOOKUP_set_cmp_func(sk, cmp)                                   \
    ((sk_X509_LOOKUP_compfunc)OPENSSL_sk_set_cmp_func(                         \
        ossl_check_X509_LOOKUP_sk_type(sk),                                    \
        ossl_check_X509_LOOKUP_compfunc_type(cmp)))
SKM_DEFINE_STACK_OF_INTERNAL(X509_OBJECT, X509_OBJECT, X509_OBJECT)
#define sk_X509_OBJECT_num(sk)                                                 \
    OPENSSL_sk_num(ossl_check_const_X509_OBJECT_sk_type(sk))
#define sk_X509_OBJECT_value(sk, idx)                                          \
    ((X509_OBJECT*)OPENSSL_sk_value(ossl_check_const_X509_OBJECT_sk_type(sk),  \
                                    (idx)))
#define sk_X509_OBJECT_new(cmp)                                                \
    ((STACK_OF(X509_OBJECT)*)OPENSSL_sk_new(                                   \
        ossl_check_X509_OBJECT_compfunc_type(cmp)))
#define sk_X509_OBJECT_new_null()                                              \
    ((STACK_OF(X509_OBJECT)*)OPENSSL_sk_new_null())
#define sk_X509_OBJECT_new_reserve(cmp, n)                                     \
    ((STACK_OF(X509_OBJECT)*)OPENSSL_sk_new_reserve(                           \
        ossl_check_X509_OBJECT_compfunc_type(cmp), (n)))
#define sk_X509_OBJECT_reserve(sk, n)                                          \
    OPENSSL_sk_reserve(ossl_check_X509_OBJECT_sk_type(sk), (n))
#define sk_X509_OBJECT_free(sk)                                                \
    OPENSSL_sk_free(ossl_check_X509_OBJECT_sk_type(sk))
#define sk_X509_OBJECT_zero(sk)                                                \
    OPENSSL_sk_zero(ossl_check_X509_OBJECT_sk_type(sk))
...
#define sk_X509_OBJECT_delete_ptr(sk, ptr)                                     \
    ((X509_OBJECT*)OPENSSL_sk_delete_ptr(ossl_check_X509_OBJECT_sk_type(sk),   \
                                         ossl_check_X509_OBJECT_type(ptr)))
#define sk_X509_OBJECT_push(sk, ptr)                                           \
    OPENSSL_sk_push(ossl_check_X509_OBJECT_sk_type(sk),                        \
                    ossl_check_X509_OBJECT_type(ptr))
#define sk_X509_OBJECT_unshift(sk, ptr)                                        \
    OPENSSL_sk_unshift(ossl_check_X509_OBJECT_sk_type(sk),                     \
                       ossl_check_X509_OBJECT_type(ptr))
#define sk_X509_OBJECT_pop(sk)                                                 \
    ((X509_OBJECT*)OPENSSL_sk_pop(ossl_check_X509_OBJECT_sk_type(sk)))
...
#define sk_X509_OBJECT_pop_free(sk, freefunc)                                  \
    OPENSSL_sk_pop_free(ossl_check_X509_OBJECT_sk_type(sk),                    \
                        ossl_check_X509_OBJECT_freefunc_type(freefunc))
#define sk_X509_OBJECT_insert(sk, ptr, idx)                                    \
    OPENSSL_sk_insert(ossl_check_X509_OBJECT_sk_type(sk),                      \
                      ossl_check_X509_OBJECT_type(ptr), (idx))
#define sk_X509_OBJECT_set(sk, idx, ptr)                                       \
    ((X509_OBJECT*)OPENSSL_sk_set(ossl_check_X509_OBJECT_sk_type(sk), (idx),   \
                                  ossl_check_X509_OBJECT_type(ptr)))
#define sk_X509_OBJECT_find(sk, ptr)                                           \
    OPENSSL_sk_find(ossl_check_X509_OBJECT_sk_type(sk),                        \
                    ossl_check_X509_OBJECT_type(ptr))
#define sk_X509_OBJECT_find_ex(sk, ptr)                                        \
    OPENSSL_sk_find_ex(ossl_check_X509_OBJECT_sk_type(sk),                     \
                       ossl_check_X509_OBJECT_type(ptr))
#define sk_X509_OBJECT_find_all(sk, ptr, pnum)                                 \
    OPENSSL_sk_find_all(ossl_check_X509_OBJECT_sk_type(sk),                    \
                        ossl_check_X509_OBJECT_type(ptr), pnum)
#define sk_X509_OBJECT_sort(sk)                                                \
    OPENSSL_sk_sort(ossl_check_X509_OBJECT_sk_type(sk))
#define sk_X509_OBJECT_is_sorted(sk)                                           \
    OPENSSL_sk_is_sorted(ossl_check_const_X509_OBJECT_sk_type(sk))
#define sk_X509_OBJECT_dup(sk)                                                 \
    ((STACK_OF(X509_OBJECT)*)OPENSSL_sk_dup(                                   \
...
#define sk_X509_OBJECT_set_cmp_func(sk, cmp)                                   \
    ((sk_X509_OBJECT_compfunc)OPENSSL_sk_set_cmp_func(                         \
        ossl_check_X509_OBJECT_sk_type(sk),                                    \
        ossl_check_X509_OBJECT_compfunc_type(cmp)))
SKM_DEFINE_STACK_OF_INTERNAL(X509_VERIFY_PARAM, X509_VERIFY_PARAM,
                             X509_VERIFY_PARAM)
#define sk_X509_VERIFY_PARAM_num(sk)                                           \
    OPENSSL_sk_num(ossl_check_const_X509_VERIFY_PARAM_sk_type(sk))
#define sk_X509_VERIFY_PARAM_value(sk, idx)                                    \
    ((X509_VERIFY_PARAM*)OPENSSL_sk_value(                                     \
        ossl_check_const_X509_VERIFY_PARAM_sk_type(sk), (idx)))
#define sk_X509_VERIFY_PARAM_new(cmp)                                          \
    ((STACK_OF(X509_VERIFY_PARAM)*)OPENSSL_sk_new(                             \
        ossl_check_X509_VERIFY_PARAM_compfunc_type(cmp)))
#define sk_X509_VERIFY_PARAM_new_null()                                        \
    ((STACK_OF(X509_VERIFY_PARAM)*)OPENSSL_sk_new_null())
#define sk_X509_VERIFY_PARAM_new_reserve(cmp, n)                               \
    ((STACK_OF(X509_VERIFY_PARAM)*)OPENSSL_sk_new_reserve(                     \
        ossl_check_X509_VERIFY_PARAM_compfunc_type(cmp), (n)))
...
#define sk_X509_VERIFY_PARAM_free(sk)                                          \
    OPENSSL_sk_free(ossl_check_X509_VERIFY_PARAM_sk_type(sk))
#define sk_X509_VERIFY_PARAM_zero(sk)                                          \
    OPENSSL_sk_zero(ossl_check_X509_VERIFY_PARAM_sk_type(sk))
#define sk_X509_VERIFY_PARAM_delete(sk, i)                                     \
    ((X509_VERIFY_PARAM*)OPENSSL_sk_delete(                                    \
        ossl_check_X509_VERIFY_PARAM_sk_type(sk), (i)))
#define sk_X509_VERIFY_PARAM_delete_ptr(sk, ptr)                               \
    ((X509_VERIFY_PARAM*)OPENSSL_sk_delete_ptr(                                \
        ossl_check_X509_VERIFY_PARAM_sk_type(sk),                              \
        ossl_check_X509_VERIFY_PARAM_type(ptr)))
#define sk_X509_VERIFY_PARAM_push(sk, ptr)                                     \
    OPENSSL_sk_push(ossl_check_X509_VERIFY_PARAM_sk_type(sk),                  \
                    ossl_check_X509_VERIFY_PARAM_type(ptr))
#define sk_X509_VERIFY_PARAM_unshift(sk, ptr)                                  \
    OPENSSL_sk_unshift(ossl_check_X509_VERIFY_PARAM_sk_type(sk),               \
                       ossl_check_X509_VERIFY_PARAM_type(ptr))
#define sk_X509_VERIFY_PARAM_pop(sk)                                           \
    ((X509_VERIFY_PARAM*)OPENSSL_sk_pop(                                       \
        ossl_check_X509_VERIFY_PARAM_sk_type(sk)))
#define sk_X509_VERIFY_PARAM_shift(sk)                                         \
    ((X509_VERIFY_PARAM*)OPENSSL_sk_shift(                                     \
        ossl_check_X509_VERIFY_PARAM_sk_type(sk)))
...
#define sk_X509_VERIFY_PARAM_insert(sk, ptr, idx)                              \
    OPENSSL_sk_insert(ossl_check_X509_VERIFY_PARAM_sk_type(sk),                \
                      ossl_check_X509_VERIFY_PARAM_type(ptr), (idx))
#define sk_X509_VERIFY_PARAM_set(sk, idx, ptr)                                 \
    ((X509_VERIFY_PARAM*)OPENSSL_sk_set(                                       \
        ossl_check_X509_VERIFY_PARAM_sk_type(sk), (idx),                       \
        ossl_check_X509_VERIFY_PARAM_type(ptr)))
#define sk_X509_VERIFY_PARAM_find(sk, ptr)                                     \
    OPENSSL_sk_find(ossl_check_X509_VERIFY_PARAM_sk_type(sk),                  \
                    ossl_check_X509_VERIFY_PARAM_type(ptr))
#define sk_X509_VERIFY_PARAM_find_ex(sk, ptr)                                  \
    OPENSSL_sk_find_ex(ossl_check_X509_VERIFY_PARAM_sk_type(sk),               \
                       ossl_check_X509_VERIFY_PARAM_type(ptr))
#define sk_X509_VERIFY_PARAM_find_all(sk, ptr, pnum)                           \
    OPENSSL_sk_find_all(ossl_check_X509_VERIFY_PARAM_sk_type(sk),              \
                        ossl_check_X509_VERIFY_PARAM_type(ptr), pnum)
#define sk_X509_VERIFY_PARAM_sort(sk)                                          \
    OPENSSL_sk_sort(ossl_check_X509_VERIFY_PARAM_sk_type(sk))
...
#define sk_X509_VERIFY_PARAM_dup(sk)                                           \
    ((STACK_OF(X509_VERIFY_PARAM)*)OPENSSL_sk_dup(                             \
...
#define sk_X509_TRUST_num(sk)                                                  \
    OPENSSL_sk_num(ossl_check_const_X509_TRUST_sk_type(sk))
#define sk_X509_TRUST_value(sk, idx)                                           \
    ((X509_TRUST*)OPENSSL_sk_value(ossl_check_const_X509_TRUST_sk_type(sk),    \
                                   (idx)))
#define sk_X509_TRUST_new(cmp)                                                 \
    ((STACK_OF(X509_TRUST)*)OPENSSL_sk_new(                                    \
...
#define sk_X509_TRUST_new_reserve(cmp, n)                                      \
    ((STACK_OF(X509_TRUST)*)OPENSSL_sk_new_reserve(                            \
        ossl_check_X509_TRUST_compfunc_type(cmp), (n)))
#define sk_X509_TRUST_reserve(sk, n)                                           \
    OPENSSL_sk_reserve(ossl_check_X509_TRUST_sk_type(sk), (n))
#define sk_X509_TRUST_free(sk)                                                 \
    OPENSSL_sk_free(ossl_check_X509_TRUST_sk_type(sk))
#define sk_X509_TRUST_zero(sk)                                                 \
    OPENSSL_sk_zero(ossl_check_X509_TRUST_sk_type(sk))
...
#define sk_X509_TRUST_delete_ptr(sk, ptr)                                      \
    ((X509_TRUST*)OPENSSL_sk_delete_ptr(ossl_check_X509_TRUST_sk_type(sk),     \
                                        ossl_check_X509_TRUST_type(ptr)))
#define sk_X509_TRUST_push(sk, ptr)                                            \
    OPENSSL_sk_push(ossl_check_X509_TRUST_sk_type(sk),                         \
                    ossl_check_X509_TRUST_type(ptr))
#define sk_X509_TRUST_unshift(sk, ptr)                                         \
    OPENSSL_sk_unshift(ossl_check_X509_TRUST_sk_type(sk),                      \
                       ossl_check_X509_TRUST_type(ptr))
#define sk_X509_TRUST_pop(sk)                                                  \
    ((X509_TRUST*)OPENSSL_sk_pop(ossl_check_X509_TRUST_sk_type(sk)))
#define sk_X509_TRUST_shift(sk)                                                \
    ((X509_TRUST*)OPENSSL_sk_shift(ossl_check_X509_TRUST_sk_type(sk)))
#define sk_X509_TRUST_pop_free(sk, freefunc)                                   \
    OPENSSL_sk_pop_free(ossl_check_X509_TRUST_sk_type(sk),                     \
                        ossl_check_X509_TRUST_freefunc_type(freefunc))
#define sk_X509_TRUST_insert(sk, ptr, idx)                                     \
    OPENSSL_sk_insert(ossl_check_X509_TRUST_sk_type(sk),                       \
                      ossl_check_X509_TRUST_type(ptr), (idx))
#define sk_X509_TRUST_set(sk, idx, ptr)                                        \
    ((X509_TRUST*)OPENSSL_sk_set(ossl_check_X509_TRUST_sk_type(sk), (idx),     \
                                 ossl_check_X509_TRUST_type(ptr)))
#define sk_X509_TRUST_find(sk, ptr)                                            \
    OPENSSL_sk_find(ossl_check_X509_TRUST_sk_type(sk),                         \
                    ossl_check_X509_TRUST_type(ptr))
#define sk_X509_TRUST_find_ex(sk, ptr)                                         \
    OPENSSL_sk_find_ex(ossl_check_X509_TRUST_sk_type(sk),                      \
                       ossl_check_X509_TRUST_type(ptr))
#define sk_X509_TRUST_find_all(sk, ptr, pnum)                                  \
    OPENSSL_sk_find_all(ossl_check_X509_TRUST_sk_type(sk),                     \
                        ossl_check_X509_TRUST_type(ptr), pnum)
#define sk_X509_TRUST_sort(sk)                                                 \
    OPENSSL_sk_sort(ossl_check_X509_TRUST_sk_type(sk))
#define sk_X509_TRUST_is_sorted(sk)                                            \
    OPENSSL_sk_is_sorted(ossl_check_const_X509_TRUST_sk_type(sk))
#define sk_X509_TRUST_dup(sk)                                                  \
    ((STACK_OF(X509_TRUST)*)OPENSSL_sk_dup(                                    \
...
#define sk_X509_TRUST_set_cmp_func(sk, cmp)                                    \
    ((sk_X509_TRUST_compfunc)OPENSSL_sk_set_cmp_func(                          \
        ossl_check_X509_TRUST_sk_type(sk),                                     \
        ossl_check_X509_TRUST_compfunc_type(cmp)))
...
typedef STACK_OF(X509) *
    (*X509_STORE_CTX_lookup_certs_fn)(X509_STORE_CTX* ctx, const X509_NAME* nm);
...
#define X509_LOOKUP_load_store_ex(x, name, libctx, propq)                      \
    X509_LOOKUP_ctrl_ex((x), X509_L_LOAD_STORE, (name), 0, NULL, (libctx),     \
                        (propq))

#define X509_LOOKUP_add_store_ex(x, name, libctx, propq)                       \
    X509_LOOKUP_ctrl_ex((x), X509_L_ADD_STORE, (name), 0, NULL, (libctx),      \
                        (propq))
...
void X509_STORE_set_check_revocation(
    X509_STORE* xs, X509_STORE_CTX_check_revocation_fn check_revocation);
...
typedef int (*X509_LOOKUP_ctrl_fn)(X509_LOOKUP* ctx, int cmd, const char* argc,
                                   long argl, char** ret);
typedef int (*X509_LOOKUP_ctrl_ex_fn)(X509_LOOKUP* ctx, int cmd,
...
typedef int (*X509_LOOKUP_get_by_subject_ex_fn)(
    X509_LOOKUP* ctx, X509_LOOKUP_TYPE type, const X509_NAME* name,
