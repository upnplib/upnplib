...
#define sk_void_value(sk, idx)                                                 \
    ((void*)OPENSSL_sk_value(ossl_check_const_void_sk_type(sk), (idx)))
#define sk_void_new(cmp)                                                       \
    ((STACK_OF(void)*)OPENSSL_sk_new(ossl_check_void_compfunc_type(cmp)))
#define sk_void_new_null() ((STACK_OF(void)*)OPENSSL_sk_new_null())
#define sk_void_new_reserve(cmp, n)                                            \
    ((STACK_OF(void)*)OPENSSL_sk_new_reserve(                                  \
        ossl_check_void_compfunc_type(cmp), (n)))
#define sk_void_reserve(sk, n)                                                 \
...
#define sk_void_delete(sk, i)                                                  \
    ((void*)OPENSSL_sk_delete(ossl_check_void_sk_type(sk), (i)))
#define sk_void_delete_ptr(sk, ptr)                                            \
    ((void*)OPENSSL_sk_delete_ptr(ossl_check_void_sk_type(sk),                 \
                                  ossl_check_void_type(ptr)))
...
#define sk_void_pop_free(sk, freefunc)                                         \
    OPENSSL_sk_pop_free(ossl_check_void_sk_type(sk),                           \
                        ossl_check_void_freefunc_type(freefunc))
#define sk_void_insert(sk, ptr, idx)                                           \
    OPENSSL_sk_insert(ossl_check_void_sk_type(sk), ossl_check_void_type(ptr),  \
                      (idx))
#define sk_void_set(sk, idx, ptr)                                              \
    ((void*)OPENSSL_sk_set(ossl_check_void_sk_type(sk), (idx),                 \
                           ossl_check_void_type(ptr)))
...
#define sk_void_find_all(sk, ptr, pnum)                                        \
    OPENSSL_sk_find_all(ossl_check_void_sk_type(sk),                           \
                        ossl_check_void_type(ptr), pnum)
...
#define sk_void_dup(sk)                                                        \
    ((STACK_OF(void)*)OPENSSL_sk_dup(ossl_check_const_void_sk_type(sk)))
#define sk_void_deep_copy(sk, copyfunc, freefunc)                              \
    ((STACK_OF(void)*)OPENSSL_sk_deep_copy(                                    \
        ossl_check_const_void_sk_type(sk),                                     \
        ossl_check_void_copyfunc_type(copyfunc),                               \
        ossl_check_void_freefunc_type(freefunc)))
#define sk_void_set_cmp_func(sk, cmp)                                          \
    ((sk_void_compfunc)OPENSSL_sk_set_cmp_func(                                \
        ossl_check_void_sk_type(sk), ossl_check_void_compfunc_type(cmp)))
...
OSSL_CRYPTO_ALLOC char* CRYPTO_strdup(const char* str, const char* file,
                                      int line);
OSSL_CRYPTO_ALLOC char* CRYPTO_strndup(const char* str, size_t s,
                                       const char* file, int line);
...
OSSL_CRYPTO_ALLOC void* CRYPTO_secure_malloc(size_t num, const char* file,
                                             int line);
OSSL_CRYPTO_ALLOC void* CRYPTO_secure_zalloc(size_t num, const char* file,
                                             int line);
