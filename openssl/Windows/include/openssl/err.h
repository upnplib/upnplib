...
#define lh_ERR_STRING_DATA_new(hfn, cmp)                                       \
    ((LHASH_OF(ERR_STRING_DATA)*)OPENSSL_LH_new(                               \
        ossl_check_ERR_STRING_DATA_lh_hashfunc_type(hfn),                      \
...
#define lh_ERR_STRING_DATA_flush(lh)                                           \
    OPENSSL_LH_flush(ossl_check_ERR_STRING_DATA_lh_type(lh))
#define lh_ERR_STRING_DATA_insert(lh, ptr)                                     \
    ((ERR_STRING_DATA*)OPENSSL_LH_insert(                                      \
        ossl_check_ERR_STRING_DATA_lh_type(lh),                                \
        ossl_check_ERR_STRING_DATA_lh_plain_type(ptr)))
#define lh_ERR_STRING_DATA_delete(lh, ptr)                                     \
    ((ERR_STRING_DATA*)OPENSSL_LH_delete(                                      \
        ossl_check_ERR_STRING_DATA_lh_type(lh),                                \
        ossl_check_const_ERR_STRING_DATA_lh_plain_type(ptr)))
#define lh_ERR_STRING_DATA_retrieve(lh, ptr)                                   \
    ((ERR_STRING_DATA*)OPENSSL_LH_retrieve(                                    \
        ossl_check_ERR_STRING_DATA_lh_type(lh),                                \
        ossl_check_const_ERR_STRING_DATA_lh_plain_type(ptr)))
#define lh_ERR_STRING_DATA_error(lh)                                           \
    OPENSSL_LH_error(ossl_check_ERR_STRING_DATA_lh_type(lh))
...
#define lh_ERR_STRING_DATA_node_usage_stats_bio(lh, out)                       \
    OPENSSL_LH_node_usage_stats_bio(                                           \
        ossl_check_const_ERR_STRING_DATA_lh_type(lh), out)
...
#define lh_ERR_STRING_DATA_doall(lh, dfn)                                      \
    OPENSSL_LH_doall(ossl_check_ERR_STRING_DATA_lh_type(lh),                   \
...
#define ERR_put_error(lib, func, reason, file, line)                           \
    (ERR_new(), ERR_set_debug((file), (line), OPENSSL_FUNC),                   \
