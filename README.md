...
The fork is based on [release-1.14.13](https://github.com/pupnp/pupnp/releases/tag/release-1.14.13) from the pupnp library. Because it is intended to be backwards compatible on the API we start with release number 1.14.0 for this repository to reflect it by following
