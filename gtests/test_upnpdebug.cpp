...
// Mocked system calls
// -------------------
class StdioMock : public StdioInterface {
  public:
...
class PthreadMock : public PthreadInterface {
  public:
...
{
    Pthread pthread_injectObj(&mocked_pthread);
    ...
    Stdio stdio_injectObj(&mocked_stdio);
